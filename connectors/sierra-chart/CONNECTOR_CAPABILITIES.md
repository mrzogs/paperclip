...
| `verify_replay_study_settings` | Parse Sierra startup/input-schema audits and compare loaded study settings against the expected backtest harness configuration. | `connectors/sierra-chart/src/replay-orchestration.mjs` | Active |
